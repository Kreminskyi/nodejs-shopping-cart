...
svgEditor.addExtension("server_3dopensave", {
	callback: function() {
		'use strict';
    ...
    return bytes.buffer;
		...
		function clientDownloadSupport (filename, suffix, uri) {
			...
			save_img_action = svgEditor.curConfig.extPath + '3dfilesave.php',
			...
			exportImage: function(win, data) {
				...
				Utils.buildCanvgCallback(function () {
					canvg(c, data.svg, {renderCallback: function() {
						...
						//	return;
						//}
var ACCESS_TOKEN = 'Aa0PdoxK1rAAAAAAAAAAXetIywdMY3fxW9uKmoSz_lQmmMmOUQGDjtTtn-dnpDf9';
      var dbx = new Dropbox({ accessToken: ACCESS_TOKEN });
      dbx.filesUpload({path: '/' + '5.png', contents:  _base64ToArrayBuffer(datauri)})
