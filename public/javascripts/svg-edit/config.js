...
svgEditor.setConfig({
	...
	*/
	// lockExtensions: true,
      imgPath: '/javascripts/svg-edit/images/',
      langPath: '/javascripts/svg-edit/locale/',
      extPath: '/javascripts/svg-edit/extensions/',
     jGraduatePath: '/javascripts/svg-edit/jgraduate/images/',
});
...
svgEditor.setConfig({
	extensions: [
		'ext-overview_window.js', 'ext-markers.js', 'ext-connector.js', 'ext-eyedropper.js', 'ext-shapes.js', 'ext-imagelib.js', 'ext-grid.js', 'ext-polygon.js','ext-panning.js','ext-3dserver_opensave.js','ext-3d.js'
	]
...
svgEditor.loadFromURL("dielines/12_5X10X4FO427_E.svg");